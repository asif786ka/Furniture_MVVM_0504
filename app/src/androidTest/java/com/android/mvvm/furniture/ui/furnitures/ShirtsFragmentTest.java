...
import com.android.mvvm.furniture.binding.FragmentBindingAdapters;
import com.android.mvvm.furniture.testing.SingleFragmentActivity;
import com.android.mvvm.furniture.ui.common.NavigationController;
import com.android.mvvm.furniture.util.RecyclerViewMatcher;
import com.android.mvvm.furniture.util.TaskExecutorWithIdlingResourceRule;
import com.android.mvvm.furniture.util.ViewModelUtil;
...
public class ShirtsFragmentTest {
    ...
    private MutableLiveData<Resource<FurnituresRepo>> repo = new MutableLiveData<>();
    private MutableLiveData<Resource<List<FurnitureEntity>>> contributors = new MutableLiveData<>();
    private FurnitureFragment shirtFragment;
    private FurnitureViewModel viewModel;
    ...
    @Before
    public void init() {
        shirtFragment = FurnitureFragment.create("a", "b");
        viewModel = mock(FurnitureViewModel.class);
    ...
    public void testValueWhileLoading() {
        /*FurnituresRepo shirts = TestUtil.createRepo("yigit", "foo", "foo-bar");
    ...
    public void testLoaded() throws InterruptedException {
        /*FurnituresRepo shirts = TestUtil.createRepo("foo", "bar", "buzz");
